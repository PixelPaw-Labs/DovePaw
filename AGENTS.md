...
This project is indexed by GitNexus as **DovePaw** (2893 symbols, 6108 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
