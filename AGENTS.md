...
This project is indexed by GitNexus as **DovePaw** (2562 symbols, 5215 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
