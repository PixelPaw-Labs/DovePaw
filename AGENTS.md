...
This project is indexed by GitNexus as **DovePaw** (3236 symbols, 7385 relationships, 263 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
