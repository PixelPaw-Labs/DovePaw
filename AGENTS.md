...
This project is indexed by GitNexus as **DovePaw** (2773 symbols, 5763 relationships, 226 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
