...
This project is indexed by GitNexus as **DovePaw** (2515 symbols, 5132 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
