...
This project is indexed by GitNexus as **DovePaw** (1834 symbols, 5080 relationships, 143 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
