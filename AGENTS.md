...
This project is indexed by GitNexus as **DovePaw** (2950 symbols, 6470 relationships, 240 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
