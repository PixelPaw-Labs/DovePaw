...
This project is indexed by GitNexus as **DovePaw** (2559 symbols, 5198 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
