...
This project is indexed by GitNexus as **DovePaw** (2566 symbols, 5222 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
