...
This project is indexed by GitNexus as **DovePaw** (3163 symbols, 7030 relationships, 257 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
