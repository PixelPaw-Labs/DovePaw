...
This project is indexed by GitNexus as **DovePaw** (3109 symbols, 6554 relationships, 251 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
