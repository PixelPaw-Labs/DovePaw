...
This project is indexed by GitNexus as **DovePaw** (3097 symbols, 6912 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
