...
This project is indexed by GitNexus as **DovePaw** (1705 symbols, 4632 relationships, 132 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
