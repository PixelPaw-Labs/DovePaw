...
This project is indexed by GitNexus as **DovePaw** (2591 symbols, 5283 relationships, 211 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
