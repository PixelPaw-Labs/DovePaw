...
This project is indexed by GitNexus as **DovePaw** (3252 symbols, 7460 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
