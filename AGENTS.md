...
This project is indexed by GitNexus as **DovePaw** (3263 symbols, 7487 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
