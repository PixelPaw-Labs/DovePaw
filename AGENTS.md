...
This project is indexed by GitNexus as **DovePaw** (2517 symbols, 5137 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
