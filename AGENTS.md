...
This project is indexed by GitNexus as **DovePaw** (2764 symbols, 5587 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
