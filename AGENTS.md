...
This project is indexed by GitNexus as **DovePaw** (4243 symbols, 8241 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
