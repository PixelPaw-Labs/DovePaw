...
This project is indexed by GitNexus as **DovePaw** (3004 symbols, 6699 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
