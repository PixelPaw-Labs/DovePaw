...
This project is indexed by GitNexus as **DovePaw** (1838 symbols, 5085 relationships, 143 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
