...
This project is indexed by GitNexus as **DovePaw** (1800 symbols, 4978 relationships, 140 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
