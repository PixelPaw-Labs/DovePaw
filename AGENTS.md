...
This project is indexed by GitNexus as **DovePaw** (2762 symbols, 5586 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
