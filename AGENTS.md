...
This project is indexed by GitNexus as **DovePaw** (2508 symbols, 5088 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
