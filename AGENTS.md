...
This project is indexed by GitNexus as **DovePaw** (2555 symbols, 5205 relationships, 208 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
