...
This project is indexed by GitNexus as **DovePaw** (3082 symbols, 6482 relationships, 248 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
