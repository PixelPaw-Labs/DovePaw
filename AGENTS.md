...
This project is indexed by GitNexus as **DovePaw** (2628 symbols, 5367 relationships, 214 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
