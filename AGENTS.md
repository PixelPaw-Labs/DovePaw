...
This project is indexed by GitNexus as **DovePaw** (2866 symbols, 6027 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
