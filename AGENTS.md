...
This project is indexed by GitNexus as **DovePaw** (3013 symbols, 6419 relationships, 242 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
