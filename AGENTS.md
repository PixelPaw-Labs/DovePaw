...
This project is indexed by GitNexus as **DovePaw** (1774 symbols, 4825 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
