...
This project is indexed by GitNexus as **DovePaw** (2867 symbols, 6041 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
