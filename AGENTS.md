...
This project is indexed by GitNexus as **DovePaw** (2992 symbols, 6620 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
