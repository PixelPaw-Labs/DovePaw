...
This project is indexed by GitNexus as **DovePaw** (1862 symbols, 5156 relationships, 145 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
