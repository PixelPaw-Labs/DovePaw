...
This project is indexed by GitNexus as **DovePaw** (1682 symbols, 4600 relationships, 130 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
