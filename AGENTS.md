...
This project is indexed by GitNexus as **DovePaw** (3170 symbols, 7030 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
