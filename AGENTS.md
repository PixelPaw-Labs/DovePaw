...
This project is indexed by GitNexus as **DovePaw** (2725 symbols, 5535 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
