...
This project is indexed by GitNexus as **DovePaw** (3083 symbols, 6492 relationships, 248 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
