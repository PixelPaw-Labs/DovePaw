...
This project is indexed by GitNexus as **DovePaw** (3402 symbols, 7702 relationships, 276 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
