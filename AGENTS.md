...
This project is indexed by GitNexus as **DovePaw** (3000 symbols, 6621 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
