...
This project is indexed by GitNexus as **DovePaw** (3415 symbols, 7731 relationships, 277 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
