...
This project is indexed by GitNexus as **DovePaw** (2982 symbols, 6190 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
