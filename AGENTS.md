...
This project is indexed by GitNexus as **DovePaw** (4118 symbols, 8055 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
