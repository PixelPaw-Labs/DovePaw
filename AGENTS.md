...
This project is indexed by GitNexus as **DovePaw** (3124 symbols, 6579 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
