...
This project is indexed by GitNexus as **DovePaw** (1866 symbols, 5153 relationships, 145 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
