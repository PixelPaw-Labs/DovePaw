...
This project is indexed by GitNexus as **DovePaw** (3083 symbols, 6875 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
