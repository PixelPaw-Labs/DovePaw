...
This project is indexed by GitNexus as **DovePaw** (2631 symbols, 5375 relationships, 215 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
