...
This project is indexed by GitNexus as **DovePaw** (3391 symbols, 7667 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
