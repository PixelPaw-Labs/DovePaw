...
This project is indexed by GitNexus as **DovePaw** (3411 symbols, 7719 relationships, 277 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
