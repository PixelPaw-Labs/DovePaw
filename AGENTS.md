...
This project is indexed by GitNexus as **DovePaw** (2518 symbols, 5147 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
