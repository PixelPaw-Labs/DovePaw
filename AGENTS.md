...
This project is indexed by GitNexus as **DovePaw** (3162 symbols, 7021 relationships, 257 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
