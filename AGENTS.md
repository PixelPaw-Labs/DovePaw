...
This project is indexed by GitNexus as **DovePaw** (3403 symbols, 7699 relationships, 276 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
