...
This project is indexed by GitNexus as **DovePaw** (3017 symbols, 6700 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
