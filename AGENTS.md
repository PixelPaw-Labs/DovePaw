...
This project is indexed by GitNexus as **DovePaw** (2667 symbols, 5465 relationships, 217 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
