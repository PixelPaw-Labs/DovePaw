...
This project is indexed by GitNexus as **DovePaw** (3422 symbols, 7779 relationships, 278 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
