...
This project is indexed by GitNexus as **DovePaw** (2776 symbols, 5767 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
