...
This project is indexed by GitNexus as **DovePaw** (2584 symbols, 5261 relationships, 211 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
