...
This project is indexed by GitNexus as **DovePaw** (2920 symbols, 6322 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
