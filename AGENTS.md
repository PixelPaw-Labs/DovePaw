...
This project is indexed by GitNexus as **DovePaw** (2911 symbols, 6301 relationships, 237 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
