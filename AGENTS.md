...
This project is indexed by GitNexus as **DovePaw** (3058 symbols, 6455 relationships, 246 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
