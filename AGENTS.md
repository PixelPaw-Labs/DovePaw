...
This project is indexed by GitNexus as **DovePaw** (3015 symbols, 6699 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
