...
This project is indexed by GitNexus as **DovePaw** (2789 symbols, 5796 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
