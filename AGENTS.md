...
This project is indexed by GitNexus as **DovePaw** (2526 symbols, 5108 relationships, 206 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
